...
cp -TRfv "$linux_build_dir/scripts/" "/usr/src/${kindtek_kernel_version}-common"
cp -TRfv "$linux_build_dir/tools/" "/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}" | tail -n 100
