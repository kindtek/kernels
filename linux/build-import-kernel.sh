...
cp -rfv "/usr/src/${linux_kernel_generic_header}" "/usr/src/${kindtek_kernel_version}-common" | tail -n 5
cp -rfv "/usr/src/${kindtek_kernel_version}-common" "kache/usr/src/${kindtek_kernel_version}-common" | tail -n 5
cp -rfv "/usr/src/${linux_kernel_kali_header}" "/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}" | tail -n 5
cp -rfv "/usr/src/${kindtek_kernel_version}-${linux_kernel_kali_header_type}" "kache/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}" | tail -n 5
