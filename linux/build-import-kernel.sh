...
rm -rfv "/usr/src/${kindtek_kernel_version}-common/scripts" | tail -n 100
rm -rfv "/usr/src/${kindtek_kernel_version}-common/tools" | tail -n 100
...
cp -TRfv "$linux_build_dir/scripts/" "/usr/src/${kindtek_kernel_version}-common/scripts" | tail -n 100
...
ln -sv "/usr/src/${kindtek_kernel_version}-common/tools" "/usr/lib/modules/linux-headers-${make_kernel_version}-${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}/tools" && \
ln -sv "/usr/src/${kindtek_kernel_version}-common/scripts" "/usr/lib/modules/linux-headers-${make_kernel_version}-${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}/scripts" && \
...
cp -TRfv "/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}common/" "kache/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}common" | tail -n 5
cp -TRfv "/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}/" "kache/usr/src/${kindtek_kernel_version}${kindtek_kernel_suffix}${linux_kernel_kali_header_type}" | tail -n 5
