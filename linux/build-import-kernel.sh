...
#
    ...
    if ("\$(\$args[1])" -ne "" -and "\$(\$args[1])" -ne "restart" ){
        ...
        wsl.exe -d "\$(\$args[1])" --cd / --user r00t --exec apt-get -y install --reinstall virtualbox;
        wsl.exe -d "\$(\$args[1])" --cd / --user r00t --exec dkms autoinstall;
        ...
        wsl.exe --cd / --user r00t --exec update-initramfs -u -k \${kernel_release}
        wsl.exe --cd / --user r00t --exec update-initramfs -u -k \${kernel_release}-dirty
        wsl.exe --cd / --user r00t --exec apt-get -y install --reinstall dkms;
        wsl.exe --cd / --user r00t --exec apt-get -y install --reinstall virtualbox;
        wsl.exe --cd / --user r00t --exec dkms autoinstall;
