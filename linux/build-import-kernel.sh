...
mkdir -pv "/usr/lib/modules/${make_kernel_version}-${linux_kernel_kali}-common"
# mkdir -pv "kache/usr/lib/modules/${make_kernel_version}-${linux_kernel_kali}-${linux_kernel_kali_header_type}"
mkdir -pv "/usr/lib/modules/${make_kernel_version}-${linux_kernel_kali}-${linux_kernel_kali_header_type}"
